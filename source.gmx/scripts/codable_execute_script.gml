...
switch (argument0)
{
    ...
    case "arctan2":
        return arctan2(argument1[0], argument1[1]);
    case "degtorad":
        return degtorad(argument1[0]);
    case "radtodeg":
        return degtorad(argument1[0]);
    case "abs":
        return abs(argument1[0]);
    case "floor":
        return floor(argument1[0]);
    case "ceil":
        return ceil(argument1[0]);
    case "round":
    ...
    case "min":
        return min(argument1[0], argument1[1]);
    case "max":
        return max(argument1[0], argument1[1]);
    case "random":
        return random(argument1[0]);
    case "irandom":
        return irandom(argument1[0]);
    case "random_range":
        return random_range(argument1[0], argument1[1]);
    case "irandom_range":
        return irandom_range(argument1[0], argument1[1]);
    case "lengthdir_x":
        return lengthdir_x(argument1[0], argument1[1]);
    case "lengthdir_y":
        return lengthdir_y(argument1[0], argument1[1]);
    case "point_distance":
        return point_distance(argument1[0], argument1[1], argument1[2], argument1[3]);
    case "point_direction":
        return point_direction(argument1[0], argument1[1], argument1[2], argument1[3]);
    default:
        return undefined;
}
