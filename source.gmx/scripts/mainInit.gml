...
global.editor_project_path = 'D:\GMSPath\jtool';
...
if (global.run_from_editor && !FS_directory_exists(global.editor_project_path))
{
...
global.window_alpha = 1;
global.last_handle = -1;
